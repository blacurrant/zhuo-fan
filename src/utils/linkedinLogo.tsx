...
type LinkedInLogoProps = React.SVGProps<SVGSVGElement> & {
  /** Pixel size for width; height auto-scales (default 84) */
  size?: number;
  /** Stroke/fill color (default currentColor so it inherits) */
  color?: string;
  /** Accessible title (set to undefined to mark decorative) */
  title?: string;
  className?: string;
};
...
const LinkedInLogo: React.FC<LinkedInLogoProps> = ({
  ...
  // original aspect ratio: 84 x 21 (4:1)
  ...
  return (
    ...
    >
      ...
      <g className="linkedin-text" fill={color}>
