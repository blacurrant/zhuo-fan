    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="px-6 py-20 container mx-auto">
        <div
          ...
          className="text-lg flex items-center gap-1 border-b border-black/50 dark:border-white/50 w-full my-8 cursor-pointer dark:text-white"
        >
          <ArrowLeft size={20} />
          <p>back.</p>
        </div>
        <div className="text-start mb-16">
          ...
          <p className="text-xl  text-start md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl leading-relaxed">
            A digital sanctuary for authentic emotional expression and gentle connection. 居場所 —
            "A place where one belongs."
          </p>
        </div>

        <div className="w-full h-96 md:h-full bg-gray-100 rounded-lg">
          <Image
            src="/ibasho/ibashoo.png"
      ...
      <section className="px-6 py-20 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto">
          <h2 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-12">
            The Challenge
          </h2>
      ...
      <section className="px-6 py-20">
        <div className="container mx-auto">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-12">
            ...
            <div className="w-full h-80 md:h-full bg-gray-100 rounded-lg mb-16">
              <Image
                src="/ibasho/journal.png"
      ...
      <section className="px-6 py-20">
        <div className="container mx-auto">
          ...
          <div className="w-fit h-80 md:h-full bg-gray-100 rounded-lg">
            <Image
              src="/ibasho/ibasho-typo.png"
      ...
      <section className="px-6 py-20">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Backend</h3>
              <ul className="text-gray-700 dark:text-gray-300 space-y-2">
      ...
      <section className="px-6 py-20">
        <div className="container mx-auto text-start">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-start">
            ...
            <button className="px-8 py-3 bg-gray-900 dark:bg-white dark:text-gray-900 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors">
              View Live Project
            </button>
            </Link>
