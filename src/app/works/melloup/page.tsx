    ...
    <div className="min-h-screen bg-white">
      ...
      <div onClick={() => router.push('/landing')} className='text-lg flex items-center gap-1 border-b border-black/50 w-full my-8 cursor-pointer'>
        ...
        <div className="text-start mb-16">
          <h1 className="text-6xl md:text-8xl font-bold text-gray-900 mb-6">Melloup</h1>
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-12">My Role</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-700">Next.js + Tailwind CSS implementation</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">UI/UX Design</h3>
              <p className="text-gray-700">Clean, modern, and scalable interface design</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Product Translation</h3>
              <p className="text-gray-700">Translating founders' vision into functional web app</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-12">The Process</h2>
        <div className='flex gap-8'>
          ...
          <div className="space-y-16 max">
            <div className="w-full flex justify-between gap-8">
              <div>
                {' '}
                <h3 className="text-2xl font-semibold text-gray-900 mb-4">1. Discovery</h3>
            ...
            <div className="w-full/50 flex justify-between gap-8">
              <div>
                {' '}
                <h3 className="text-2xl font-semibold text-gray-900 mb-4">2. Design</h3>
                <p className="text-gray-700 max-w-5xl leading-relaxed mb-6">
            ...
            <div className="w-full flex justify-between gap-8">
              <div>
                {' '}
                <h3 className="text-2xl font-semibold text-gray-900 mb-4">3. Development</h3>
      ...
      <section className="px-6 py-20">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">🌐 Marketing Website</h3>
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-12">Impact</h2>

          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Business Results</h3>
      ...
      <section className="px-6 py-20">
        <div className="container mx-auto">
          <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-12">Key Learnings</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="border-l-4 border-purple-500 pl-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Modern Stack Advantages</h3>
              <p className="text-gray-700">
